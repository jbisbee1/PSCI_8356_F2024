...
<<<<<<< HEAD
&= Pr\bigg(\frac{\hat{\theta} - \theta_A}{\sigma_{\hat{\theta}}} < \frac{\theta_0 + z_{\alpha}\sigma_{\hat{\theta}} - \theta_A}{\sigma_{\hat{\theta}}} | \theta = \theta_A\bigg)\\
=======
&= Pr\bigg(\frac{\hat{\theta} - \theta_A}{\sigma_{\hat{\theta}}} < \frac{\theta_0 + z_{\alpha}\sigma_{\hat{\theta}}}{\sigma_{\hat{\theta}}} | \theta = \theta_A\bigg)\\
>>>>>>> c86805864e1ae2bd94aebe73d7f3e5f265988ee3
...
<<<<<<< HEAD
- And we can use the usual approach to show that $\sigma_{\hat{\theta}} = \frac{\sigma}{\sqrt{n}}$
...
- (Remember for these examples, we are assuming $\theta_0 - \theta_A < 0$)
