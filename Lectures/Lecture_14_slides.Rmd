...
- Theorem: Linear combination of independent, Normally-distributed RVs is itself Normally distributed
  ...
  - See Chapter 6 for proof if interested
...
- Similar to the Normal:
  ...
  - Symmetric around 0, but..."fatter tails"
...
# Review of inference with one variable
...
```{r}
require(tidyverse)
dat <- read_rds('https://github.com/jbisbee1/PSCI_8356_F2024/raw/main/Lectures/Data/sc_debt.Rds')
