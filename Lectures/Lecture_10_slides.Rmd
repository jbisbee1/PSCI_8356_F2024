...
&= \frac{1}{n}\bigg(\sum_i (E[Y_i^2] \color{red}{- E[Y_i]^2 + E[Y_i]^2}) - nE[\bar{Y}^2]\color{red}{- nE[\bar{Y}]^2 + nE[\bar{Y}]^2}\bigg)\\
&= \frac{1}{n}\bigg(\sum_i (VAR(Y_i) + E[Y_i]^2) - n(VAR(\bar{Y}) + E[\bar{Y}]^2)\bigg)
\end{aligned}
$$
...
P(-\sigma_{\hat{\theta}}z_{\alpha/2}  \leq \hat{\theta}-\theta \leq \sigma_{\hat{\theta}}z_{\alpha/2} ) &= 1-\alpha\\
P(\hat{\theta}-\sigma_{\hat{\theta}}z_{\alpha/2} \leq \theta \leq \hat{\theta}+\sigma_{\hat{\theta}}z_{\alpha/2}) &= 1-\alpha
\end{aligned}
$$

- Thus $\hat{\theta}_L = \hat{\theta}-\sigma_{\hat{\theta}}z_{\alpha/2}$ and $\hat{\theta}_H = \hat{\theta}+\sigma_{\hat{\theta}}z_{\alpha/2}$
